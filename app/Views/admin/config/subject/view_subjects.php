...
$data  = $model->findAll(); // SELECT * FROM SUBJECT
?>
...
<main class="mx-auto" style="max-width: 60rem;">
  <header class="d-flex justify-content-between align-items-center">
    <h1>Asignaturas</h1>
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#create_modal">Crear Asignatura</button>
  </header>
            ...
            <?php foreach ($data as $row) : ?>
              <tr>
                ...
                <td class="d-flex gap-3">
                  <a href="<?= base_url('/a/configuracion/asignatura/editar/' . $row['id']) ?>" class="btn btn-outline-warning d-flex align-items-center justify-content-center" style="width: 2.5rem;">
                    <span class="material-symbols-rounded">
                      edit
                    </span>
                  </a>
...
<div class="modal fade" id="create_modal" tabindex="-1">
  <form class="modal-dialog modal-dialog-scrollable" action="<?= base_url('/a/configuracion/asignatura/nuevo') ?>" method="post">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Agregar Asignatura</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <div class="mb-3">
          <label for="subject_name" class="form-label">Asignatura <span class="text-danger">*</span></label>
          <input class="form-control" id="subject_name" name="subject_name" placeholder="Nombre de la asignatura" required>
        </div>
        <div class="mb-3">
          <label for="subject_description" class="form-label">Descripción <span class="text-danger">*</span></label>
          <input class="form-control" id="subject_description" name="subject_description" placeholder="Descripción de la asignatura" required>
        </div>
      </div>
...
<div class="modal fade" id="delete_modal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Eliminar Asignatura</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?= base_url('/a/configuracion/asignatura/eliminar') ?>" method="post">
