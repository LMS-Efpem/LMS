...
<main class="m-auto" style="max-width: min(100%, 500px);">
  <form action="<?= base_url('/a/configuracion/nacionalidad/editar') ?>" method="post">
    ...
    <div class="my-3">
      ...
      <input type="text" class="form-control" id="nationality_cod1" name="nationality_cod1" value="<?= $nationality['alpha2'] ?>" required>
    </div>
    <div class="my-3">
      <label for="nationality_cod2" class="form-label">Código 2 <span class="text-danger">*</span></label>
      <input type="text" class="form-control" id="nationality_cod2" name="nationality_cod2" value="<?= $nationality['alpha3'] ?>" required>
    </div>
    <div class="my-3">
      <label for="nationality_name" class="form-label">Nombre de la Nacionalidad <span class="text-danger">*</span></label>
      <input type="text" class="form-control" id="nationality_name" name="nationality_name" value="<?= $nationality['name'] ?>" required>
    </div>
    <div>
      <button type="submit" class="btn btn-warning">Guardar Cambios</button>
      <a href="<?= base_url('/a/configuracion/nacionalidad/') ?>" class="btn btn-secondary">Descartar</a>
    </div>
  </form>
</main>
