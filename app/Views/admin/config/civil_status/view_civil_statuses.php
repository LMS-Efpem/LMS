...
$data  = $model->findAll(); // SELECT * FROM civil_status
?>
...
<main class="mx-auto" style="max-width: 40rem;">
  <header class="d-flex justify-content-between align-items-center">
    ...
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#create_modal">Crear Estado Civil</button>
  </header>
            ...
            <?php foreach ($data as $row) : ?>
              <tr>
                ...
                <td class="d-flex gap-3">
                  <a href="<?= base_url('/a/configuracion/estado-civil/editar/' . $row['id']) ?>" class="btn btn-outline-warning d-flex align-items-center justify-content-center" style="width: 2.5rem;">
                    <span class="material-symbols-rounded">
                      edit
                    </span>
                  </a>
...
<div class="modal fade" id="create_modal" tabindex="-1">
  <form class="modal-dialog modal-dialog-scrollable" action="<?= base_url('/a/configuracion/estado-civil/nuevo') ?>" method="post">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Agregar Estado Civil</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <div class="mb-3">
          <label for="civil_status" class="form-label">Estado Civil <span class="text-danger">*</span></label>
          <input class="form-control" id="civil_status" name="civil_status" placeholder="Nombre del Estado Civil" required>
        </div>
        <div class="mb-3">
          <label for="civil_status_description" class="form-label">Descripción <span class="text-danger">*</span></label>
          <input class="form-control" id="civil_status_description" name="civil_status_description" placeholder="Descripción del Estado Civil" required>
        </div>
      </div>
...
<div class="modal fade" id="delete_modal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Eliminar Estado Civil</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?= base_url('/a/configuracion/estado-civil/eliminar') ?>" method="post">
