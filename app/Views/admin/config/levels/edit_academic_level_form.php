...
<main class="m-auto" style="max-width: min(100%, 500px);">
  <form action="<?= base_url('/a/configuracion/niveles-academicos/editar') ?>" method="post">
    <input type="hidden" name="id" value="<?= $unit['id'] ?>">
    <div class="my-3">
      <label for="levels_name" class="form-label">Nombre del Nivel <span class="text-danger">*</span></label>
      <input type="text" class="form-control" id="levels_name" name="levels_name" value="<?= $unit['description'] ?>" required>
    </div>
    <div>
      <button type="submit" class="btn btn-warning">Guardar Cambios</button>
      <a href="<?= base_url('/a/configuracion/niveles-academicos/') ?>" class="btn btn-secondary">Descartar</a>
    </div>
  </form>
</main>
