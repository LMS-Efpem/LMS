            ...
            <?php foreach ($data as $row) : ?>
              <tr>
                ...
                <td class="d-flex gap-3">
                  <a href="<?= base_url('/a/configuracion/genero/editar/' . $row['id']) ?>" class="btn btn-outline-warning d-flex align-items-center justify-content-center" style="width: 2.5rem;">
                    <span class="material-symbols-rounded">
                      edit
                    </span>
                  </a>
  ...
  <form class="modal-dialog modal-dialog-scrollable" action="<?= base_url('/a/configuracion/genero/nuevo') ?>" method="post">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <label for="gender_description" class="form-label">Descripción <span class="text-danger">*</span></label>
          <input class="form-control" id="gender_description" name="gender_description" placeholder="Descripción de Genero" required>
        </div>
      </div>
