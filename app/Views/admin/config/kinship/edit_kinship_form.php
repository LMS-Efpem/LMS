...
<main class="m-auto" style="max-width: min(100%, 500px);">
  <form action="<?= base_url('/a/configuracion/parentesco/editar') ?>" method="post">
    <input type="hidden" name="id" value="<?= $unit['id'] ?>">
    <div class="my-3">
      <label for="kinship_name" class="form-label">Parentesco <span class="text-danger">*</span></label>
      <input type="text" class="form-control" id="kinship_name" name="kinship_name" value="<?= $unit['description'] ?>" required>
    </div>
    <div>
      <button type="submit" class="btn btn-warning">Guardar Cambios</button>
      <a href="<?= base_url('/a/configuracion/parentesco/') ?>" class="btn btn-secondary">Descartar</a>
    </div>
  </form>
</main>
