            ...
            <?php foreach ($data as $row) : ?>
              <tr>
                ...
                <td class="d-flex gap-3">
                  <a href="<?= base_url('/a/configuracion/parentesco/editar/' . $row['id']) ?>" class="btn btn-outline-warning d-flex align-items-center justify-content-center" style="width: 2.5rem;">
                    <span class="material-symbols-rounded">
                      edit
                    </span>
                  </a>
...
<div class="modal fade" id="create_modal" tabindex="-1">
  <form class="modal-dialog modal-dialog-scrollable" action="<?= base_url('/a/configuracion/parentesco/nuevo') ?>" method="post">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Agregar Parentesco</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <div class="mb-3">
          <label for="kinship_name" class="form-label">Parentesco <span class="text-danger">*</span></label>
          <input class="form-control" id="kinship_name" name="kinship_name" placeholder="Parentesco" required>
        </div>
        <div class="mb-3">
          <label for="kinship_description" class="form-label">Descripción <span class="text-danger">*</span></label>
          <input class="form-control" id="kinship_description" name="kinship_description" placeholder="Descripción de Parentesco" required>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('/a/configuracion/parentesco/eliminar') ?>" method="post">
        ...
        <div class="modal-body">
          <p>¿Está seguro que desea eliminar este parentesco?</p>
