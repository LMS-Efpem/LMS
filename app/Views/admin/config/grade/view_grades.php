...
<main class="mx-auto" style="max-width: 40rem;">
  <header class="d-flex justify-content-between align-items-center">
    <h1>Grados</h1>
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#create_modal">Crear Grado</button>
  </header>
...
<div class="modal fade" id="create_modal" tabindex="-1">
  <form class="modal-dialog modal-dialog-scrollable" action="<?= base_url('/a/configuracion/grados/nuevo') ?>" method="post">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Agregar Grado</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <div class="mb-3">
          <label for="grade_name" class="form-label">Grado <span class="text-danger">*</span></label>
...
<div class="modal fade" id="delete_modal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title h5">Eliminar grado</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?= base_url('/a/configuracion/grados/eliminar') ?>" method="post">
        <input type="hidden" name="id" value="0" /> <!-- No borrar -->
        <div class="modal-body">
          <p>¿Está seguro que desea eliminar este grado?</p>
