<nav class="navbar fixed-top navbar-expand bg-body-secondary">
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="<?= base_url('/t/perfiles/') ?>" class="nav-link">
            Perfiles
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('/t/notas/') ?>" class="nav-link">
            Calificaciones
          </a>
        </li>
        <li class="nav-item active">
          <a href="<?= base_url('/t/carga-academica/') ?>" class="nav-link">
            Carga Académica
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url('/t/configuracion') ?>" class="nav-link">
            Configuración
          </a>
        </li>
      </ul>
