...
{
    /**
     * Este método se utiliza como filtro para verificar si el usuario es un estudiante y ha iniciado sesión.
     *
     * Si no se ha iniciado sesión, se redirige al login con un mensaje de error.
     * Si se ha iniciado sesión pero no es un estudiante,
